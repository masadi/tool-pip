        ...
        <b-col cols="12" md="6">
          <div class="d-flex align-items-center justify-content-end">
            ...
            <v-select v-model="statusFilter" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
              :options="statusOptions" class="invoice-filter-select" placeholder="Pilih Status">
    ...
    <b-table ref="refInvoiceListTable" :items="fetchInvoices" responsive :fields="tableColumns" primary-key="id"
      ...
      <template #cell(actions)="data">
        ...
        <div class="text-nowrap">
          <feather-icon :id="`invoice-row-${data.item.id}-send-icon`" icon="SendIcon" class="cursor-pointer"
            size="16" />
...
export default {
  ...
  setup() {
    ...
    const statusOptions = ['Pengguna', 'Non Pengguna']
