    ...
    onEachFeatureFunction: function onEachFeatureFunction() {
      return function (feature, layer) {
        ...
        layer.on('click', function (e) {
          console.log(e);
          console.log(popup);
          popup.setLatLng(e.latlng).setContent("<ul class='list-group list-group no-padding'>" + "<li class='list-group-item list-group-item-info'><b>{{$wilayah->nama}}</b></li>" + "<li class='list-group-item list-group-item-warning'><a href='{{$link}}'>" + feature.properties.sekolah + " SMK</a></li>" + "</ul>");
        });
