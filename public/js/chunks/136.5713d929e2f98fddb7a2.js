...
/* harmony import */ var _casl_ability__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @casl/ability */ "./node_modules/@casl/ability/dist/es5m/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          ...
          _this.$http.post('/auth/login', {
            ...
            _this.updateAbility(userData.user);
    ...
    updateAbility: function updateAbility(user) {
      var _AbilityBuilder = new _casl_ability__WEBPACK_IMPORTED_MODULE_13__["AbilityBuilder"](),
