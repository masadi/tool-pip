...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setData: function setData(peserta_didik_id) {
      ...
      return null;
      //return (data.length) ? data[0].peserta_didik_id : null;
    ...
    simpanData: function simpanData(item) {
      ...
      this.$http.post('/periodik', {
        ...
        tinggi: this.form.tinggi[item.peserta_didik_id],
        berat: this.form.berat[item.peserta_didik_id],
        kepala: this.form.kepala[item.peserta_didik_id],
        saudara: this.form.saudara[item.peserta_didik_id]
