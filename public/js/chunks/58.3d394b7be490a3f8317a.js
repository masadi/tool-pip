...
/* harmony default export */ __webpack_exports__["default"] = ({
      ...
      mapOptions: {
        ...
        onEachFeature: function onEachFeature(feature, layer) {
          layer.on('mouseover', function (e) {
            ...
            //open popup
            var popup = L.popup().setLatLng(e.latlng).setContent('<h1 style="color: grey; margin-bottom: 0;">' + feature.properties.Name + '</h1>');
  ...
  methods: {
    innerClick: function innerClick(wilayah) {
      console.log('click');
    }
  },
  props: {
  ...
  computed: {
    options: function options(wilayah) {
      console.log(wilayah);
      return {
