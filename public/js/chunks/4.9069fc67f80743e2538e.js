...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setData: function setData(peserta_didik_id) {
      var data = this.items.filter(function (item) {
        return item.peserta_didik_id === peserta_didik_id;
      });
      if (data.length) {
        var setValue = data[0];
        if (setValue.periodik) {
          this.form.tinggi[peserta_didik_id] = setValue.periodik.tinggi_badan;
          this.form.berat[peserta_didik_id] = setValue.periodik.berat_badan;
          this.form.kepala[peserta_didik_id] = setValue.periodik.lingkar_kepala;
          this.form.saudara[peserta_didik_id] = setValue.periodik.jumlah_saudara_kandung;
        }
      }
      return null;
    },
    simpanData: function simpanData(item) {
      var _this = this;
      console.log(item);
      return false;
    ...
    showModal: function showModal(item) {
      ...
      this.$http.get('/kelayakan').then(function (response) {
        _this2.$refs['my-modal'].show();
        _this2.kelayakan = response.data;
      });
    },
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Datatable_vue_vue_type_template_id_402b8bad___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Datatable_vue_vue_type_template_id_402b8bad___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Datatable_vue_vue_type_template_id_402b8bad___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_laravel_mix_node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Datatable_vue_vue_type_template_id_402b8bad___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
