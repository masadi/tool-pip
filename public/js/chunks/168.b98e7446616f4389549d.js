      ...
      return {
        ...
        onEachFeature: function onEachFeature(feature, layer) {
          ...
          layer.on('click', function (e) {
            ...
            http.get('/dashboard/wilayah/' + kode_wilayah + '?longitude=' + e.latlng.lat + '&latitude=' + e.latlng.lng, {
              params: {
              ...
              markers.push({
                ...
                link: '/rekapitulasi-wilayah/' + e.target.feature.properties.KD_PRO + '?longitude=' + e.latlng.lat + '&latitude=' + e.latlng.lng,
