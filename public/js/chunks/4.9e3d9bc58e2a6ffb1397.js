  ...
  methods: {
    ...
    simpanData: function simpanData(item) {
      ...
      this.$http.post('/periodik', {
        ...
        tinggi: this.form.tinggi[this.peserta_didik_id],
        berat: this.form.berat[this.peserta_didik_id],
        kepala: this.form.kepala[this.peserta_didik_id],
        saudara: this.form.saudara[this.peserta_didik_id]
