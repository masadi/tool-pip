...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.$http.get('/dashboard/index').then(function (response) {
      ...
      _this.data.wilayah.chartOptionsLg.tooltip = {
        y: {
      ...
      _this.data.wilayah.chartOptionsSm.tooltip = {
        y: {
          formatter: function formatter(val) {
            return val + " SMK";
          }
      ...
      _c(
        ...
        [
          _c("b-table", {
            attrs: {
              striped: "",
              items: _vm.item_provinsi,
              fields: _vm.field_provinsi,
              busy: _vm.isBusy,
              "show-empty": "",
      ...
      : _c(
          ...
          [
            ...
            _c(
              ...
              [
                _c("b-link", { staticClass: "d-none d-xl-block" }, [
                  _vm._v(
                    "Jumlah SMK Pengguna " +
                ...
                _vm._v(" "),
                _c("b-link", { staticClass: "d-block d-xl-none" }, [
                  _vm._v(
                    "SMK Pengguna " +
                      _vm._s(_vm.kFormatter(_vm.data.smk_nasional))
                  ),
          ...
          _c(
            ...
            [
              _c("dashboard-pengguna", {
                attrs: {
                  item_provinsi: _vm.data.item_provinsi,
                  field_provinsi: _vm.field_provinsi,
                  last_sync: _vm.data.last_sync,
                  isBusy: _vm.isBusy,
                },
              }),
