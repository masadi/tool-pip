...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      url: 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
      attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
      marker: Object(leaflet__WEBPACK_IMPORTED_MODULE_3__["latLng"])(-2.2196220, 117.5646680),
      //
      markers: [],
      option: {}
    };
  ...
  methods: {
    ...
    options: function options(option) {
      ...
      this.all_wilayah.length = 0;
      var all_wilayah = this.all_wilayah;
        ...
        onEachFeature: function onEachFeature(feature, layer) {
          ...
          layer.on('click', function (e) {
            ...
            http.get('/dashboard/wilayah/' + kode_wilayah, {
              ...
              console.log(all_wilayah);
              all_wilayah = data.all_wilayah;
              console.log(all_wilayah);
