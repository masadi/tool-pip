...
/* harmony import */ var _maps_leaflet_LeafletBasic_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../maps/leaflet/LeafletBasic.vue */ "./resources/js/src/views/dashboard/maps/leaflet/LeafletBasic.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    //WilayahGeoJSON,
    LeafletBasic: _maps_leaflet_LeafletBasic_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
          ...
          layer.on('click', function (e) {
            ...
            http.get('/dashboard/wilayah/' + kode_wilayah + '/' + e.latlng.lat + '/' + e.latlng.lng, {
              ...
              markers.push({
                ...
                link: app_url + '/rekapitulasi-wilayah' + e.target.feature.properties.KD_KAB + '/' + e.latlng.lat + '/' + e.latlng.lng,
