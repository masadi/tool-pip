...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.$http.get('/dashboard/wilayah/' + this.$route.params.kode_wilayah + '/' + this.$route.params.longitude + '/' + this.$route.params.latitude).then(function (response) {
      ...
      _this.data.longitude = parseFloat(_this.data.longitude);
      _this.data.latitude = parseFloat(_this.data.latitude);
        ...
        [
          ...
          _c(
            "l-map",
            {
              ...
              attrs: { zoom: _vm.zoom, center: [_vm.longitude, _vm.latitude] },
            },
            [
              _c("l-tile-layer", {
