...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    setTinggi: function setTinggi() {
      var _this = this;
      return function (item) {
        _this.form.tinggi[item.peserta_didik_id] = item.periodik ? item.periodik.tinggi_badan : 0;
        _this.form.berat[item.peserta_didik_id] = item.periodik ? item.periodik.berat_badan : 0;
        _this.form.kepala[item.peserta_didik_id] = item.periodik ? item.periodik.lingkar_kepala : 0;
        _this.form.saudara[item.peserta_didik_id] = item.periodik ? item.periodik.jumlah_saudara_kandung : 0;
  ...
  methods: {
    ...
    showModal: function showModal(item) {
      ...
      this.$http.get('/kelayakan').then(function (response) {
        ...
        _this3.kelayakan = response.data;
      });
    },
