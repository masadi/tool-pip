...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    LFeatureGroup: vue2_leaflet__WEBPACK_IMPORTED_MODULE_4__["LFeatureGroup"],
  ...
  created: function created() {
    ...
    this.$http.get('/dashboard/wilayah').then(function (response) {
      ...
      data.all_wilayah.forEach(function (item, index) {
        //console.log(item);
        var response = fetch('https://rawgit.com/gregoiredavid/france-geojson/master/regions/pays-de-la-loire/communes-pays-de-la-loire.geojson');
        _this.geojson = response.json();
      });
