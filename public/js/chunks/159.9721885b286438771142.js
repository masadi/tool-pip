...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      marker: Object(leaflet__WEBPACK_IMPORTED_MODULE_4__["latLng"])(-2.2331, 117.2841),
      //
      markers: [],
      option: {}
    };
    ...
    options: function options(option) {
      ...
      return {
        ...
        onEachFeature: function onEachFeature(feature, layer) {
          ...
          layer.bindTooltip("<div>" + feature.properties.NM_PRO + "</div><div>Jml SMK: " + feature.properties.NM_PRO + "</div>", {
            permanent: false,
            sticky: true
          });
